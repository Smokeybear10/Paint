...
val debug : widget -> widget

(*****************************************)
(** {1   Slider widget                } *)
(*****************************************)

(** A slider widget that allows selecting an integer value within a range.
    slider min_val max_val init_val label_text returns a widget and value controller.
    The user can click or drag on the slider to change the value. *)
val slider : int -> int -> int -> string -> widget * int value_controller
